...
public class Rogue extends Character {
    public Rogue(float x, float y, float speed) {
        super(
            new Texture(Gdx.files.internal("rogue_idle.png")),
            new Texture(Gdx.files.internal("rogue_run.png")),
            new Texture(Gdx.files.internal("rogue_runattack.png")),
            new Texture(Gdx.files.internal("rogue_attack.png")),
